...
public:
  ...
  /**
   *  Make CLV components to be recomputed for all species nodes upon a CLV update
   */
...
private:
  ...
  /**
   *  Fill the nodes vector with all the children of the given node based
   *  on the model's species tree representation. Use to fill _prunedSpeciesNodes.
   *  Nodes are filled in the postorder fashion
   */
...
protected:
  ...
  // number of gene copies covering each species leaf. Not computed by this class
  std::vector<unsigned int> _speciesCoverage;
  // number of species leaves covered by this gene family. Not computed by this class
